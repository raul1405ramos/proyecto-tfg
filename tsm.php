...
<div class="container mt-5">
    <h1 class="text-center mb-5">¡Noticias registradas con Taiwan Semiconductor Manufacturing Company Limited!</h1>
    <div class="row">
        <?php
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    btnsReadMore.forEach(function(btn) {
        btn.addEventListener("click", function() {
            ...
            popup.document.write("<h2 style='text-align:center;'>Gráfica de Taiwan Semiconductor Manufacturing Company Limited</h2>");
            popup.document.write("<br>");
            // Segunda imagen con tamaño fijo y centrada
            var secondImageElement = "./GRAFICASTFG/GRAFICA TSM.jpg";
