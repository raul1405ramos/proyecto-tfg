...
<div class="container mt-5">
    <h1 class="text-center mb-5">¡Noticias registradas con Bank of America Corporation!</h1>
    <div class="row">
        <?php
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    btnsReadMore.forEach(function(btn) {
        btn.addEventListener("click", function() {
            ...
            popup.document.write("<div id='google_translate_element'></div>")
            popup.document.write("<h2 style='text-align:center;'>Gráfica de Bank of America Corporation</h2>");
            popup.document.write("<br>");
            // Segunda imagen con tamaño fijo y centrada
            var secondImageElement = "./GRAFICASTFG/GRAFICA BAC.jpg";
            ...
            popup.document.write("function googleTranslateElementInit(){");
            popup.document.write("new google.translate.TranslateElement({pageLanguage: 'en'}, 'google_translate_element');");
            popup.document.write("}");
            popup.document.write("<script type='text/javascript' src='//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit'")
